...
public class MongoDBProducer implements Serializable{
	...
	private final String uri = "mongodb://javeson:FXMTmOU64YEsTiLA@cluster0-shard-00-00-xk8og.mongodb.net:27017,cluster0-shard-00-01-xk8og.mongodb.net:27017,cluster0-shard-00-02-xk8og.mongodb.net:27017/<DATABASE>?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin";
