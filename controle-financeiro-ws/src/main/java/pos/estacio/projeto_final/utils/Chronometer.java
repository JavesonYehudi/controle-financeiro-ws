 ...
 * 
 * It could be used with the DEFAULT implementation of Cron, or with custom crons, by passing a name for the custom cron.
 * 
 * @author Felipe Brito
 *
 */
public final class Chronometer {
	 ...
	 * 
	 * @param snippetMarker Name or simple marker of snippet to be profiled
	 */
	 ...
	 * 
	 * @param cronName Name of instance of the chronometer to be manipulated
	 * @param snippetMarker Name or simple marker of snippet to be profiled
	 */
	...
	/**
	 * Retrieves the Cron instance for cronName passed. If it don't exists, create and returns a new instance.
	 * 
	 * @param cronName Name of instance of the chronometer to be manipulated
	...
	private final class Cron {
		...
		public void start(String snippetMarker) {
			...
			if (!paused) {
				System.out.println("----------------------");
				System.out.println("Cronômetro Iniciado em " + new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(new Date(this.startValue)) + ": " + snippetMarker);
				System.out.println("----------------------");
			}
		...
		public void stop(String snippetMarker) {
			...
			System.out.println("----------------------");
			System.out.println("Cronômetro Finalizado: "+ snippetMarker);
			System.out.println("----------------------");
			System.out.println("Tempo: " + this.elapsedTime + " milisegundos.");
			System.out.println("----------------------\n");
